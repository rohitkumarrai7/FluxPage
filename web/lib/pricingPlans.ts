...
const PRO_ORIGINAL =
  process.env.NEXT_PUBLIC_RAZORPAY_PRO_ORIGINAL_DISPLAY || "₹999";
const PREMIUM_SALE = process.env.NEXT_PUBLIC_RAZORPAY_PREMIUM_DISPLAY || "₹399";
const PREMIUM_ORIGINAL =
  process.env.NEXT_PUBLIC_RAZORPAY_PREMIUM_ORIGINAL_DISPLAY || "₹2,499";
...
function launchTagline(original: string, sale: string, period: string): string {
  return `Launch pricing — was ${original}, now ${sale}${period}`;
}
...
export const PRICING_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    launchTagline: launchTagline(PRO_ORIGINAL, PRO_SALE, "/month"),
    period: "/month",
    features: [
      "100 tailors/month",
      "20 resumes",
  ...
  },
  {
    ...
    launchTagline: launchTagline(PREMIUM_ORIGINAL, PREMIUM_SALE, "/month"),
    period: "/month",
    features: [
      "Unlimited tailoring",
      "Unlimited resumes",
