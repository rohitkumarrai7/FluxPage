...
import { Logo, SpinnerCenter, CeoAgencyCredit } from "@/components/ui";
...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/recruiter", label: "Recruiter", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const [user, setUser] = useState<any>(() =>
    typeof window !== "undefined" ? api.auth.getUser() : null
  );
  ...
  if (!user && profileLoading) return <SpinnerCenter className="min-h-screen" />;
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <footer className="hidden lg:block border-t border-border px-8 py-3 bg-surface">
