(function () {
  ...
  function buildSidebar() {
    var sidebarWidth = Math.min(420, Math.max(320, window.innerWidth));
    shadowHost = document.createElement("div");
    shadowHost.id = "resumod-sidebar-shadow-host";
    shadowHost.setAttribute("style",
      "position: fixed; top: 0; right: 0; width: " + sidebarWidth + "px; max-width: 100vw; height: 100vh; z-index: 2147483647; pointer-events: none;"
    );
...
function basicPdfTextExtraction(base64Data) {
  ...
  async function onSaveSettings() {
    var cfg = {
      apiEndpoint: $("#apiEndpoint").value.trim() || getDefaultApiEndpoint(),
  ...
  var TEMPLATE =
    ...
    '<style>' +
      ...
      '#resumod-sidebar.minimized::before {' +
        ...
        'background: center / contain no-repeat url(__LOGO_URL__);' +
      '}' +
    '</style>';
})();
